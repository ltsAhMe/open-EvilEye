package mjt.lef.asm.transformers;
...
import mjt.lef.client.listener.events.input.EventKeyInput;
...
public class MinecraftTransformer extends Wrapper {
    ...
    public void displayGuiScreen(MethodNode methodNode) {
        InsnList list = new InsnList();
        list.add(new MethodInsnNode(INVOKESTATIC, Type.getInternalName(MinecraftWrapper.class), "get", "()Lmjt/lef/asm/wrapper/impl/MinecraftWrapper;", false));
